...
/**
 * utility functions help to have interaction with elements:
 * takeSnapShot
 */
public class utility {
	...
	/**
	 * The method waits for the element with the forwarded selector to become clickable (displayed and enabled)
	...
	/**
	 * The method waits for the page title to be equal to the forwarded string
	 * @param driver
